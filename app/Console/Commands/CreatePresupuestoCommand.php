...
class CreatePresupuestoCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'crear:presupuesto
    ...
    public function handle()
    {
        ...
        Presupuesto::factory($cantidad)->create([
            'proyecto' => $proyecto
        ]);
        $this->info("{$cantidad} Presupuesto(s) creado(s) exitosamente \nPor favor revisa la base de datos");
        return 0;
    }
}
